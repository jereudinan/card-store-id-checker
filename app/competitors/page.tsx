...
export const metadata: Metadata = createPageMetadata({ title: "우리 가게 주변 경쟁업체 조회", description: "현재 사업장 위치를 기준으로 반경 300m·500m·1km 안의 같은 업종 가게 수와 거리, 업종, 주소를 확인하세요.", path: "/competitors/" });

export default function CompetitorsPage() {
  const structuredData = [{ "@context": "https://schema.org", "@type": "WebApplication", name: "우리 가게 주변 경쟁업체 조회", url: `${SITE_URL}/competitors/`, applicationCategory: "BusinessApplication", operatingSystem: "All", description: "사업장 주변의 같은 업종 상가 수와 거리, 주소를 확인하는 무료 상권 조회 서비스", offers: { "@type": "Offer", price: "0", priceCurrency: "KRW" }, inLanguage: "ko-KR" }, createBreadcrumbs([{ name: "홈", path: "/" }, { name: "주변 경쟁업체 조회", path: "/competitors/" }])];
